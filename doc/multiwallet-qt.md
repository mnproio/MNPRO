...
In order to support loading of multiple wallets in mnpro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnpro.cpp.
...
Changes to mnpro.cpp
----------------------
mnpro.cpp is the entry point into mnpro-qt, and as such, will require some minor modifications to provide hooks for
