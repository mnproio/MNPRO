...
Intro
-----
MNPRO (MNPR) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MNPRO utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mnpro-qt.exe.

MNPRO Core is the original MNPRO client and it builds the backbone of the network.
However, it downloads and stores the entire history of MNPRO transactions;
