...
#   c) node1 mines 32 blocks, so now node 0 has 500000MNPR, node 1 has 4250MNPR, node2 has none.
#   d) node0 sends 601 MNPR to node2, in two transactions (301 MNPR, then 300 MNPR).
