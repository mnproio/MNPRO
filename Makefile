...
pkgdatadir = $(datadir)/mnpro
pkgincludedir = $(includedir)/mnpro
pkglibdir = $(libdir)/mnpro
pkglibexecdir = $(libexecdir)/mnpro
...
CONFIG_HEADER = $(top_builddir)/src/config/mnpro-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/mnpro-config.h.in \
...
ACLOCAL = ${SHELL} /home/mnpro-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mnpro-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mnpro-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mnpro-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = mnpro-cli
BITCOIN_DAEMON_NAME = mnprod
BITCOIN_GUI_NAME = mnpro-qt
BITCOIN_TX_NAME = mnpro-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/mnpro-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = MNPRO Core
PACKAGE_STRING = MNPRO Core 2.0.0
PACKAGE_TARNAME = mnpro
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/mnpro-core
abs_srcdir = /home/mnpro-core
abs_top_builddir = /home/mnpro-core
abs_top_srcdir = /home/mnpro-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mnpro-core/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_mnpro_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_mnpro_coverage.info test_mnpro.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin1.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MNPRcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/mnpro-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/mnpro-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/mnpro-config.h
$(top_srcdir)/src/config/mnpro-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/mnpro-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MNPRcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MNPRcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MNPRcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_mnpro.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_mnpro -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_mnpro_filtered.info: test_mnpro.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_mnpro_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_mnpro_coverage.info: baseline_filtered_combined.info test_mnpro_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mnpro_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_mnpro_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mnpro_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_mnpro.coverage/.dirstamp:  test_mnpro_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_mnpro.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_mnpro.coverage/ total.coverage/ $(OSX_APP)
