/* src/config/mnpro-config.h.  Generated from mnpro-config.h.in by configure.  */
/* src/config/mnpro-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MNPR_CONFIG_H

#define MNPR_CONFIG_H
...
#define PACKAGE_NAME "MNPRO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MNPRO Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mnpro"
